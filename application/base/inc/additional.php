...
if ( !function_exists('the_cache') ) {
    
    /**
     * The function the_cache returns the cache
     * 
...
if ( !function_exists('add_cache') ) {
    
    /**
     * The function add_cache saves cache
     * 
     * @param string $cache_id contains the cache's id
     ...
     * @return void
     */
    function add_cache($cache_id, $cache_value) {
...
if ( !function_exists('delete_cache') ) {
    ...
    /**
     * The function delete_cache deletes the cache
     * 
     * @param string $cache_id contains the cache's id
     * 
     * @since 0.0.8.3
