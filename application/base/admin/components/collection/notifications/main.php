...
defined('MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION') OR define('MIDRUB_BASE_ADMIN_COMPONENTS_NOTIFICATIONS_VERSION', '0.0.6');
...
class Main implements MidrubBaseAdminInterfaces\Admin {
    ...
    public function load_hooks($category) {
        ...
        if ( (substr($this->CI->input->post('action', TRUE), 0, 21) === 'create_email_template') || (substr($this->CI->input->post('action', TRUE), 0, 21) === 'update_email_template') ) {
            ...
            // Set component
            set_global_variable('component', 'notifications');
