...
class Main implements MidrubBasePaymentsInterfaces\Payments {
    ...
    public function guest() {
        ...
        if ( the_option('paypal_client_id') && the_option('paypal_client_secret') ) {
    ...
    public function delete_subscription($subscription) {
        ...
        if ( isset($subscription['net_id']) ) {
            ...
            if ( the_option('paypal_client_id') && the_option('paypal_client_secret') ) {
                ...
                CURLOPT_USERPWD => the_option('paypal_client_id') . ':' . the_option('paypal_client_secret'),
