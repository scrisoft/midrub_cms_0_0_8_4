...
add_hook(
    ...
    function () {
        ...
        echo "<script src=\"" . base_url('assets/base/user/themes/green/js/main.js?ver=' . MD_VER) . "\"></script>\n";
...
add_hook(
    ...
    function () {
        ...
        if ( the_option('component_notifications_enable') ) {
            ...
            $this->CI->load->ext_model( MIDRUB_BASE_USER . 'themes/green/models/', 'Green_notifications_model', 'green_notifications_model' );
            ...
            // Get notifications
            $notifications = $CI->green_notifications_model->the_notifications_alerts($where);
...
add_hook(
    ...
    function () {
        ...
        if ( the_option('component_faq_enable') ) {
            ...
            // Load Tickets Model
            $this->CI->load->ext_model( MIDRUB_BASE_USER . 'themes/green/models/', 'Green_tickets_model', 'green_tickets_model' );

            // Get all tickets
            $all_tickets = $CI->green_tickets_model->get_all_tickets_for( $CI->user_id );
