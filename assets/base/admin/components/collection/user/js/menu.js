        ...
        if ( status === 'success' ) {
            ...
            for (var l = 0; l < items.length; l++) {
                ...
                for (var s = 0; s < data.languages.length; s++) {
                    ...
                    // Get random number
                    var random_number = Math.floor(Math.random() * 9999999);
                    ...
                    + '<div class="form-group">'
                        ...
                        + '<div class="row">'
                            + '<div class="col-lg-6">'
                                + '<div class="dropdown" data-option="theme-item-' + data.languages[s] + '-pages-list-' + random_number + '">'
                                    ...
                                    + '<div class="dropdown-menu" aria-labelledby="dropdown-items">'
                                        + '<div class="card">'
                                            + '<div class="card-head">'
                                                + '<input type="text" class="search-dropdown-items theme-item-' + data.languages[s] + '-pages-list-' + random_number + '-search" placeholder="' + data.words.search_component_or_app + '">'
                                            + '</div>'
                                            + '<div class="card-body">'
                                                + '<ul class="list-group theme-item-dropdown-pages-list theme-item-' + data.languages[s] + '-pages-list-' + random_number + '-list">'
                                                + '</ul>'
                                            + '</div>'
                                        + '</div>'
                                    + '</div>'
        ...
        for ( var l = 0; l < Main.available_languages.length; l++ ) {
            ...
            tabs += '<div id="' + Main.available_languages[l] + '-' + random_number + '" class="tab-pane fade' + tab_active + '" data-lang="' + Main.available_languages[l] + '">'
                    ...
                    + '<div class="form-group">'
                        ...
                        + '<div class="row">'
                            + '<div class="col-lg-6">'
                                + '<div class="dropdown" data-option="theme-item-' + Main.available_languages[l] + '-pages-list-' + random_number + '">'
                                    ...
                                    + '<div class="dropdown-menu" aria-labelledby="dropdown-items">'
                                        + '<div class="card">'
                                            + '<div class="card-head">'
                                                + '<input type="text" class="search-dropdown-items theme-item-' + Main.available_languages[l] + '-pages-list-' + random_number + '-search" placeholder="' + Main.menu_item_words.search_component_or_app + '">'
                                            + '</div>'
                                            + '<div class="card-body">'
                                                + '<ul class="list-group theme-item-dropdown-pages-list theme-item-' + Main.available_languages[l] + '-pages-list-' + random_number + '-list">'
                                                + '</ul>'
                                            + '</div>'
                                        + '</div>'
                                    + '</div>'
