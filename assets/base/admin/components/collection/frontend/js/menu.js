                            ...
                            + '<div class="col-lg-6">'
                                + '<div class="dropdown" data-option="theme-item-' + data.languages[s] + '-pages-list-' + random_number + '">'
                                    ...
                                    + '<div class="dropdown-menu" aria-labelledby="dropdown-items">'
                                        + '<div class="card">'
                                            + '<div class="card-head">'
                                                + '<input type="text" class="search-dropdown-items theme-item-' + data.languages[s] + '-pages-list-' + random_number + '-search" placeholder="' + data.words.search_page + '">'
                                            + '</div>'
                                            + '<div class="card-body">'
                            ...
                            + '<div class="col-lg-6">'
                                + '<div class="dropdown" data-option="theme-item-' + Main.available_languages[l] + '-pages-list-' + random_number + '">'
                                    ...
                                    + '<div class="dropdown-menu" aria-labelledby="dropdown-items">'
                                        + '<div class="card">'
                                            + '<div class="card-head">'
                                                + '<input type="text" class="search-dropdown-items theme-item-' + Main.available_languages[l] + '-pages-list-' + random_number + '-search" placeholder="' + Main.menu_item_words.search_page + '">'
                                            + '</div>'
                                            + '<div class="card-body">'
